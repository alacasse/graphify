...
def test_project_codebuddy_install_writes_complete_project_scope_only(tmp_path, monkeypatch):
...
def test_uninstall_all_removes_both_codebuddy_scopes(tmp_path, monkeypatch):
    ...
    unrelated_hook = {"matcher": "Write", "hooks": [{"type": "command", "command": "keep-me"}]}
