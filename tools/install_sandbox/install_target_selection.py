...
try:
    ...
    from install_target_models import InstallCommandVariant, InstallSurface, PlatformSpec, Scenario  # type: ignore[no-redef]
    from install_target_scenarios import _generic_install_command, _skill  # type: ignore[no-redef]
