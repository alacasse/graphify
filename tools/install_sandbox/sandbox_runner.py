...
def scenario_lifecycle_hooks(
    *,
    ...
    return scenario_lifecycle.ScenarioLifecycleHooks(
        ...
        seed_user_owned_content=oracle.seed_user_owned_content,
        write_file_manifest=write_file_manifest,
        run_capture=command_runner.run_capture,
        scenario_file_state=oracle.scenario_file_state,
        assert_expected_files=oracle.assert_expected_files,
        assert_scope_boundaries=oracle.assert_scope_boundaries,
        assert_no_unexpected_graphify_files=oracle.assert_no_unexpected_graphify_files,
        copy_generated_files=oracle.copy_generated_files,
        assert_idempotent_state=file_effects.assert_idempotent_state,
        seed_stale_skill_sidecars=oracle.seed_stale_skill_sidecars,
        assert_installed_skill_sidecars=oracle.assert_installed_skill_sidecars,
        assert_uninstalled=oracle.assert_uninstalled,
        ...
        known_status_values=known_status_values,
        expected_generated_relative_keys=oracle.expected_generated_relative_keys,
