...
Install Target Catalog. The YAML name `eligible_platform_scope` is public schema
compatibility for that Harness Policy input; defer any rename to a separate
